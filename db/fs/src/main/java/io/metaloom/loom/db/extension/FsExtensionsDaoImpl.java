...
@Singleton
public class FsExtensionsDaoImpl extends AbstractFSDao implements ExtensionsDao {

	@Inject
	public FsExtensionsDaoImpl(DaoCollection daos) {
		super(daos);
	}
	...
	public Extension createExtension() {
		Extension extension = new FsExtensionImpl(daos());
