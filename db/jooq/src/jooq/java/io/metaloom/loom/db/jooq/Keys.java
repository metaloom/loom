...
public class Keys {
    ...
    public static final UniqueKey<AssetBinaryRecord> ASSET_BINARY_PKEY = Internal.createUniqueKey(AssetBinary.ASSET_BINARY, DSL.name("asset_binary_pkey"), new TableField[] { AssetBinary.ASSET_BINARY.UUID }, true);
    ...
    public static final ForeignKey<AssetRecord, AssetBinaryRecord> ASSET__ASSET_ASSET_BINARY_UUID_FKEY = Internal.createForeignKey(Asset.ASSET, DSL.name("asset_asset_binary_uuid_fkey"), new TableField[] { Asset.ASSET.ASSET_BINARY_UUID }, Keys.ASSET_BINARY_PKEY, new TableField[] { AssetBinary.ASSET_BINARY.UUID }, true);
