...
public class Keys {
    ...
    public static final UniqueKey<FaceRecord> FACE_PKEY = Internal.createUniqueKey(Face.FACE, DSL.name("face_pkey"), new TableField[] { Face.FACE.UUID }, true);
    public static final UniqueKey<FaceRecord> FACE_SOURCE_KEY = Internal.createUniqueKey(Face.FACE, DSL.name("face_source_key"), new TableField[] { Face.FACE.SOURCE }, true);
    ...
    public static final UniqueKey<RolePermissionRecord> ROLE_PERMISSION_PKEY = Internal.createUniqueKey(RolePermission.ROLE_PERMISSION, DSL.name("role_permission_pkey"), new TableField[] { RolePermission.ROLE_PERMISSION.ROLE_UUID, RolePermission.ROLE_PERMISSION.RESOURCE }, true);
    ...
    public static final UniqueKey<TokenPermissionRecord> TOKEN_PERMISSION_PKEY = Internal.createUniqueKey(TokenPermission.TOKEN_PERMISSION, DSL.name("token_permission_pkey"), new TableField[] { TokenPermission.TOKEN_PERMISSION.TOKEN_UUID, TokenPermission.TOKEN_PERMISSION.RESOURCE }, true);
    ...
    public static final UniqueKey<UserPermissionRecord> USER_PERMISSION_PKEY = Internal.createUniqueKey(UserPermission.USER_PERMISSION, DSL.name("user_permission_pkey"), new TableField[] { UserPermission.USER_PERMISSION.USER_UUID, UserPermission.USER_PERMISSION.RESOURCE }, true);
