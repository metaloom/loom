...
public enum JooqLoomEvent implements EnumType {
    ...
    private JooqLoomEvent(String literal) {
     ...
     */
    public static JooqLoomEvent lookupLiteral(String literal) {
        return EnumType.lookupLiteral(JooqLoomEvent.class, literal);
    }
}
