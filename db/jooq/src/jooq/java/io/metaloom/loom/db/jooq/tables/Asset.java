...
public class Asset extends TableImpl<AssetRecord> {
     ...
     */
    public final TableField<AssetRecord, java.util.UUID> ASSET_BINARIES_UUID = createField(DSL.name("asset_binaries_uuid"), SQLDataType.UUID.nullable(false), this, "");
     ...
     * element
     */
    public final TableField<AssetRecord, JSONB> META = createField(DSL.name("meta"), SQLDataType.JSONB, this, "Custom meta properties to the element");
    ...
    private transient AssetBinarie _assetBinarie;
