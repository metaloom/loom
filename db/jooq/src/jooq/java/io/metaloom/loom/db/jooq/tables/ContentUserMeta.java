...
public class ContentUserMeta extends TableImpl<ContentUserMetaRecord> {
     ...
     * properties
     */
    public final TableField<ContentUserMetaRecord, JSONB> META = createField(DSL.name("meta"), SQLDataType.JSONB, this, "Custom meta properties");
    ...
    @Override
    public ContentUserMeta as(Table<?> alias) {
        return new ContentUserMeta(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public ContentUserMeta rename(Table<?> name) {
        return new ContentUserMeta(name.getQualifiedName(), null);
    }
