...
public class Group extends TableImpl<GroupRecord> {
     ...
     * element
     */
    public final TableField<GroupRecord, JSONB> META = createField(DSL.name("meta"), SQLDataType.JSONB, this, "Custom meta properties to the element");

    /**
     * The column <code>public.group.created</code>.
     */
    public final TableField<GroupRecord, LocalDateTime> CREATED = createField(DSL.name("created"), SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field("now()", SQLDataType.LOCALDATETIME)), this, "");
