...
public class JooqAssetUserMeta extends TableImpl<JooqAssetUserMetaRecord> {
     ...
     * the user
     */
    public final TableField<JooqAssetUserMetaRecord, Integer> RATING = createField(DSL.name("rating"), SQLDataType.INTEGER, this, "Asset rating by the user");

    /**
     * The column <code>public.asset_user_meta.meta</code>. Custom meta
     * properties
     */
    public final TableField<JooqAssetUserMetaRecord, JSONB> META = createField(DSL.name("meta"), SQLDataType.JSONB, this, "Custom meta properties");
