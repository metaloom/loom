...
public class JooqTag extends TableImpl<JooqTagRecord> {
     ...
     */
    public final TableField<JooqTagRecord, java.util.UUID> NAMESPACE_UUID = createField(DSL.name("namespace_uuid"), SQLDataType.UUID.nullable(false), this, "");
    ...
    public JooqNamespace namespace() {
        if (_namespace == null)
            _namespace = new JooqNamespace(this, Keys.TAG__TAG_NAMESPACE_UUID_FKEY);
