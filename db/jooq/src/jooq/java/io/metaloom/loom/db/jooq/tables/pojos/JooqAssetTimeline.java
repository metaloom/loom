...
public class JooqAssetTimeline implements Serializable {
    ...
    public JooqAssetTimeline(JooqAssetTimeline value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final JooqAssetTimeline other = (JooqAssetTimeline) obj;
        if (this.uuid == null) {
            if (other.uuid != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("JooqAssetTimeline (");
