...
public class JooqCluster implements Serializable {
    ...
    public JooqCluster(JooqCluster value) {
     ...
     * person)
     */
    public void setType(JooqClusterType type) {
        this.type = type;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final JooqCluster other = (JooqCluster) obj;
        if (this.uuid == null) {
            if (other.uuid != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("JooqCluster (");
