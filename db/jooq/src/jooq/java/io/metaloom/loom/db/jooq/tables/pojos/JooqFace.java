...
public class JooqFace implements Serializable {
    ...
    public JooqFace(JooqFace value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final JooqFace other = (JooqFace) obj;
        if (this.uuid == null) {
            if (other.uuid != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("JooqFace (");
