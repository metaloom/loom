...
public class JooqGroup implements Serializable {
    ...
    public JooqGroup(JooqGroup value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final JooqGroup other = (JooqGroup) obj;
        if (this.uuid == null) {
            if (other.uuid != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("JooqGroup (");
