...
public class JooqTagNamespace implements Serializable {
    ...
    public JooqTagNamespace(JooqTagNamespace value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final JooqTagNamespace other = (JooqTagNamespace) obj;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("JooqTagNamespace (");
