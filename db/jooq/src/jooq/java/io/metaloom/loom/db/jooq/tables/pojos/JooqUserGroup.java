...
public class JooqUserGroup implements Serializable {
    ...
    public JooqUserGroup(JooqUserGroup value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final JooqUserGroup other = (JooqUserGroup) obj;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("JooqUserGroup (");
