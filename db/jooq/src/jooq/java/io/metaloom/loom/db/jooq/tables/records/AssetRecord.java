...
public class AssetRecord extends UpdatableRecordImpl<AssetRecord> implements Record17<UUID, UUID, UUID, String, String, String, Integer, String, String, BigDecimal, BigDecimal, String, String, LocalDateTime, UUID, LocalDateTime, UUID> {
     ...
     */
    public void setAssetBinaryUuid(UUID value) {
        set(1, value);
    }
