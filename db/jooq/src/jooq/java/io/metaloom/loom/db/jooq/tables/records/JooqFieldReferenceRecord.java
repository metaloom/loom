...
public class JooqFieldReferenceRecord extends UpdatableRecordImpl<JooqFieldReferenceRecord> implements Record3<UUID, UUID, String> {
    ...
    public Field<UUID> field1() {
        return JooqFieldReference.FIELD_REFERENCE.SOURCE_UUID;
    }

    @Override
    public Field<UUID> field2() {
        return JooqFieldReference.FIELD_REFERENCE.TARGET_UUID;
    }

    @Override
    public Field<String> field3() {
        return JooqFieldReference.FIELD_REFERENCE.FIELD_NAME;
    }
    ...
    @Override
    public JooqFieldReferenceRecord value1(UUID value) {
        setSourceUuid(value);
        return this;
    }

    @Override
    public JooqFieldReferenceRecord value2(UUID value) {
        setTargetUuid(value);
        return this;
    }

    @Override
    public JooqFieldReferenceRecord value3(String value) {
        setFieldName(value);
        return this;
    }

    @Override
    public JooqFieldReferenceRecord values(UUID value1, UUID value2, String value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
    ...
    /**
     * Create a detached JooqFieldReferenceRecord
     */
    public JooqFieldReferenceRecord() {
        super(JooqFieldReference.FIELD_REFERENCE);
    }

    /**
     * Create a detached, initialised JooqFieldReferenceRecord
     */
    public JooqFieldReferenceRecord(UUID sourceUuid, UUID targetUuid, String fieldName) {
        super(JooqFieldReference.FIELD_REFERENCE);
     ...
     * Create a detached, initialised JooqFieldReferenceRecord
     */
    public JooqFieldReferenceRecord(io.metaloom.loom.db.jooq.tables.pojos.JooqFieldReference value) {
        super(JooqFieldReference.FIELD_REFERENCE);
