...
public class JooqFlywaySchemaHistoryRecord extends UpdatableRecordImpl<JooqFlywaySchemaHistoryRecord> implements Record10<Integer, String, String, String, String, Integer, String, LocalDateTime, Integer, Boolean> {
    ...
    public Field<Integer> field1() {
        return JooqFlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY.INSTALLED_RANK;
    }

    @Override
    public Field<String> field2() {
        return JooqFlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY.VERSION;
    }

    @Override
    public Field<String> field3() {
        return JooqFlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY.DESCRIPTION;
    }

    @Override
    public Field<String> field4() {
        return JooqFlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY.TYPE;
    }

    @Override
    public Field<String> field5() {
        return JooqFlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY.SCRIPT;
    }

    @Override
    public Field<Integer> field6() {
        return JooqFlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY.CHECKSUM;
    }

    @Override
    public Field<String> field7() {
        return JooqFlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY.INSTALLED_BY;
    }

    @Override
    public Field<LocalDateTime> field8() {
        return JooqFlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY.INSTALLED_ON;
    }

    @Override
    public Field<Integer> field9() {
        return JooqFlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY.EXECUTION_TIME;
    }

    @Override
    public Field<Boolean> field10() {
        return JooqFlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY.SUCCESS;
    }
    ...
    @Override
    public JooqFlywaySchemaHistoryRecord value1(Integer value) {
        setInstalledRank(value);
        return this;
    }

    @Override
    public JooqFlywaySchemaHistoryRecord value2(String value) {
        setVersion(value);
        return this;
    }

    @Override
    public JooqFlywaySchemaHistoryRecord value3(String value) {
        setDescription(value);
        return this;
    }

    @Override
    public JooqFlywaySchemaHistoryRecord value4(String value) {
        setType(value);
        return this;
    }

    @Override
    public JooqFlywaySchemaHistoryRecord value5(String value) {
        setScript(value);
        return this;
    }

    @Override
    public JooqFlywaySchemaHistoryRecord value6(Integer value) {
        setChecksum(value);
        return this;
    }

    @Override
    public JooqFlywaySchemaHistoryRecord value7(String value) {
        setInstalledBy(value);
        return this;
    }

    @Override
    public JooqFlywaySchemaHistoryRecord value8(LocalDateTime value) {
        setInstalledOn(value);
        return this;
    }

    @Override
    public JooqFlywaySchemaHistoryRecord value9(Integer value) {
        setExecutionTime(value);
        return this;
    }

    @Override
    public JooqFlywaySchemaHistoryRecord value10(Boolean value) {
        setSuccess(value);
        return this;
    }

    @Override
    public JooqFlywaySchemaHistoryRecord values(Integer value1, String value2, String value3, String value4, String value5, Integer value6, String value7, LocalDateTime value8, Integer value9, Boolean value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    /**
     * Create a detached JooqFlywaySchemaHistoryRecord
     */
    public JooqFlywaySchemaHistoryRecord() {
     ...
     */
    public JooqFlywaySchemaHistoryRecord(Integer installedRank, String version, String description, String type, String script, Integer checksum, String installedBy, LocalDateTime installedOn, Integer executionTime, Boolean success) {
        super(JooqFlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY);
