...
public class JooqRoleRecord extends UpdatableRecordImpl<JooqRoleRecord> implements Record7<UUID, String, JSONB, LocalDateTime, UUID, LocalDateTime, UUID> {
    ...
    @Override
    public JooqRoleRecord value3(JSONB value) {
        setMeta(value);
        return this;
    }
    ...
    @Override
    public JooqRoleRecord values(UUID value1, String value2, JSONB value3, LocalDateTime value4, UUID value5, LocalDateTime value6, UUID value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JooqRoleRecord(UUID uuid, String name, JSONB meta, LocalDateTime created, UUID creatorUuid, LocalDateTime edited, UUID editorUuid) {
        super(JooqRole.ROLE);
