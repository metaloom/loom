...
public class JooqTagRecord extends UpdatableRecordImpl<JooqTagRecord> implements Record10<UUID, String, String, UUID, JSONB, Integer, LocalDateTime, UUID, LocalDateTime, UUID> {
    ...
    public Field<UUID> field4() {
        return JooqTag.TAG.NAMESPACE_UUID;
    }
    ...
    @Override
    public JooqTagRecord value4(UUID value) {
        setNamespaceUuid(value);
        return this;
    }

    @Override
    public JooqTagRecord value5(JSONB value) {
        setMeta(value);
        return this;
    }

    @Override
    public JooqTagRecord value6(Integer value) {
        setRating(value);
        return this;
    }
    ...
    @Override
    public JooqTagRecord values(UUID value1, String value2, String value3, UUID value4, JSONB value5, Integer value6, LocalDateTime value7, UUID value8, LocalDateTime value9, UUID value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JooqTagRecord(UUID uuid, String name, String collection, UUID namespaceUuid, JSONB meta, Integer rating, LocalDateTime created, UUID creatorUuid, LocalDateTime edited, UUID editorUuid) {
        super(JooqTag.TAG);
