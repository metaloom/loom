...
public class JooqTokenRecord extends UpdatableRecordImpl<JooqTokenRecord> implements Record9<UUID, String, String, String, LocalDateTime, UUID, LocalDateTime, UUID, JSONB> {
    ...
    @Override
    public Row9<UUID, String, String, String, LocalDateTime, UUID, LocalDateTime, UUID, JSONB> fieldsRow() {
        return (Row9) super.fieldsRow();
    }

    @Override
    public Row9<UUID, String, String, String, LocalDateTime, UUID, LocalDateTime, UUID, JSONB> valuesRow() {
    ...
    @Override
    public JooqTokenRecord value9(JSONB value) {
        setMeta(value);
        return this;
    }

    @Override
    public JooqTokenRecord values(UUID value1, String value2, String value3, String value4, LocalDateTime value5, UUID value6, LocalDateTime value7, UUID value8, JSONB value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JooqTokenRecord(UUID uuid, String name, String description, String token, LocalDateTime created, UUID creatorUuid, LocalDateTime edited, UUID editorUuid, JSONB meta) {
        super(JooqToken.TOKEN);
