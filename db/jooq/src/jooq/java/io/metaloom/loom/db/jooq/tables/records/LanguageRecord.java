...
public class LanguageRecord extends UpdatableRecordImpl<LanguageRecord> implements Record4<UUID, String, String, JSONB> {
    ...
    @Override
    public LanguageRecord value4(JSONB value) {
        setMeta(value);
        return this;
    }

    @Override
    public LanguageRecord values(UUID value1, String value2, String value3, JSONB value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LanguageRecord(UUID uuid, String nativeName, String tag, JSONB meta) {
        super(Language.LANGUAGE);
