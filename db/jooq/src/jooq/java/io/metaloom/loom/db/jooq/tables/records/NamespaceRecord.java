...
public class NamespaceRecord extends UpdatableRecordImpl<NamespaceRecord> implements Record10<UUID, String, UUID, JSONB, String, String, LocalDateTime, UUID, LocalDateTime, UUID> {
    ...
    public Field<String> field6() {
        return Namespace.NAMESPACE.MODEL_FILTER;
    }
    ...
    @Override
    public NamespaceRecord value4(JSONB value) {
        setMeta(value);
        return this;
    }
    ...
    @Override
    public NamespaceRecord values(UUID value1, String value2, UUID value3, JSONB value4, String value5, String value6, LocalDateTime value7, UUID value8, LocalDateTime value9, UUID value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public NamespaceRecord(UUID uuid, String name, UUID rootContentUuid, JSONB meta, String pathPrefix, String modelFilter, LocalDateTime created, UUID creatorUuid, LocalDateTime edited, UUID editorUuid) {
        super(Namespace.NAMESPACE);
