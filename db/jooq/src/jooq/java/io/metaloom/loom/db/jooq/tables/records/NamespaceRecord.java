...
public class NamespaceRecord extends UpdatableRecordImpl<NamespaceRecord> implements Record10<UUID, String, UUID, String, String, String, LocalDateTime, UUID, LocalDateTime, UUID> {
    ...
    /**
     * Setter for <code>public.namespace.model_filters</code>. filter for models
    ...
    /**
     * Getter for <code>public.namespace.model_filters</code>. filter for models
     * that can be used in the namespace
     */
