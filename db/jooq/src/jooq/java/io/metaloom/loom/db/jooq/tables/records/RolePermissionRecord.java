...
public class RolePermissionRecord extends UpdatableRecordImpl<RolePermissionRecord> implements VertxPojo, Record8<UUID, UUID, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean>, IRolePermission {
     ...
     */
    @Override
    public RolePermissionRecord setRoleUuid(UUID value) {
        set(0, value);
        return this;
    }
     ...
     */
    @Override
    public RolePermissionRecord setElementUuid(UUID value) {
        set(1, value);
        return this;
    }
     ...
     */
    @Override
    public RolePermissionRecord setCreatePerm(Boolean value) {
        set(2, value);
        return this;
    }
     ...
     */
    @Override
    public RolePermissionRecord setReadPerm(Boolean value) {
        set(3, value);
        return this;
    }
     ...
     */
    @Override
    public RolePermissionRecord setDeletePerm(Boolean value) {
        set(4, value);
        return this;
    }
     ...
     */
    @Override
    public RolePermissionRecord setUpdatePerm(Boolean value) {
        set(5, value);
        return this;
    }
     ...
     */
    @Override
    public RolePermissionRecord setReadPublishPerm(Boolean value) {
        set(6, value);
        return this;
    }
     ...
     */
    @Override
    public RolePermissionRecord setPublishPerm(Boolean value) {
        set(7, value);
        return this;
    }
    ...
    public RolePermissionRecord(UUID roleUuid, UUID elementUuid, Boolean createPerm, Boolean readPerm, Boolean deletePerm, Boolean updatePerm, Boolean readPublishPerm, Boolean publishPerm) {
        ...
        public RolePermissionRecord(io.vertx.core.json.JsonObject json) {
                this();
                fromJson(json);
        }
}
