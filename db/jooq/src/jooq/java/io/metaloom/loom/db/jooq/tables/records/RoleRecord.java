...
public class RoleRecord extends UpdatableRecordImpl<RoleRecord> implements Record7<UUID, String, JSONB, LocalDateTime, UUID, LocalDateTime, UUID> {
    ...
    @Override
    public RoleRecord value3(JSONB value) {
        setMeta(value);
        return this;
    }
    ...
    @Override
    public RoleRecord value5(UUID value) {
    ...
    @Override
    public RoleRecord value7(UUID value) {
        setEditorUuid(value);
        return this;
    }

    @Override
    public RoleRecord values(UUID value1, String value2, JSONB value3, LocalDateTime value4, UUID value5, LocalDateTime value6, UUID value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RoleRecord(UUID uuid, String name, JSONB meta, LocalDateTime created, UUID creatorUuid, LocalDateTime edited, UUID editorUuid) {
        super(Role.ROLE);
