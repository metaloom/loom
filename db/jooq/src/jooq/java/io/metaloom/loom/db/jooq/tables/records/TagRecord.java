...
public class TagRecord extends UpdatableRecordImpl<TagRecord> implements Record10<UUID, String, String, UUID, String, Integer, LocalDateTime, UUID, LocalDateTime, UUID> {
