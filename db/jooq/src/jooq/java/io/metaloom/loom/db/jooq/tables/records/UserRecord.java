...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record14<UUID, String, String, String, String, String, Boolean, Boolean, String, LoomPermissionFlag, LocalDateTime, UUID, LocalDateTime, UUID> {
