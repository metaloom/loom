...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record13<UUID, String, String, String, String, String, Boolean, Boolean, JSONB, LocalDateTime, UUID, LocalDateTime, UUID> {
    ...
    @Override
    public UserRecord values(UUID value1, String value2, String value3, String value4, String value5, String value6, Boolean value7, Boolean value8, JSONB value9, LocalDateTime value10, UUID value11, LocalDateTime value12, UUID value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserRecord(UUID uuid, String username, String firstname, String lastname, String passwordhash, String email, Boolean enabled, Boolean sso, JSONB meta, LocalDateTime created, UUID creatorUuid, LocalDateTime edited, UUID editorUuid) {
        super(User.USER);
