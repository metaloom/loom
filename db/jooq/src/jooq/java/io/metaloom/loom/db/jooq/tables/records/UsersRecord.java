...
public class UsersRecord extends UpdatableRecordImpl<UsersRecord> implements Record14<UUID, String, String, String, String, String, Boolean, Boolean, JSONB, LoomPermissionFlag, LocalDateTime, UUID, LocalDateTime, UUID> {
    ...
    /**
     * Setter for <code>public.users.enabled</code>. Flag to enable or disable
     * the user.
     */
    ...
    /**
     * Getter for <code>public.users.enabled</code>. Flag to enable or disable
     * the user.
     */
    ...
    /**
     * Setter for <code>public.users.sso</code>. Flag that indicates that the
    ...
    /**
     * Getter for <code>public.users.sso</code>. Flag that indicates that the
     * user was created via SSO mappings
     */
    ...
    /**
     * Setter for <code>public.users.meta</code>. Custom meta properties to the
     * element
     */
    ...
    /**
     * Getter for <code>public.users.meta</code>. Custom meta properties to the
     * element
     */
    ...
    /**
     * Setter for <code>public.users.permissions</code>.
     */
    ...
    /**
     * Getter for <code>public.users.permissions</code>.
     */
    ...
    /**
     * Setter for <code>public.users.creator_uuid</code>.
     */
    ...
    /**
     * Getter for <code>public.users.creator_uuid</code>.
     */
    ...
    /**
     * Setter for <code>public.users.edited</code>.
     */
    ...
    /**
     * Getter for <code>public.users.edited</code>.
     */
    ...
    /**
     * Setter for <code>public.users.editor_uuid</code>.
     */
    ...
    /**
     * Getter for <code>public.users.editor_uuid</code>.
     */
    ...
    public Field<UUID> field12() {
        return Users.USERS.CREATOR_UUID;
    }

    @Override
    public Field<LocalDateTime> field13() {
        return Users.USERS.EDITED;
    }

    @Override
    public Field<UUID> field14() {
        return Users.USERS.EDITOR_UUID;
    }
    ...
    @Override
    public UsersRecord value9(JSONB value) {
        setMeta(value);
        return this;
    }

    @Override
    public UsersRecord value10(LoomPermissionFlag value) {
    ...
    @Override
    public UsersRecord value14(UUID value) {
        setEditorUuid(value);
        return this;
    }

    @Override
    public UsersRecord values(UUID value1, String value2, String value3, String value4, String value5, String value6, Boolean value7, Boolean value8, JSONB value9, LoomPermissionFlag value10, LocalDateTime value11, UUID value12, LocalDateTime value13, UUID value14) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UsersRecord(UUID uuid, String username, String firstname, String lastname, String passwordhash, String email, Boolean enabled, Boolean sso, JSONB meta, LoomPermissionFlag permissions, LocalDateTime created, UUID creatorUuid, LocalDateTime edited, UUID editorUuid) {
        super(Users.USERS);
