...
public class WebhookRecord extends UpdatableRecordImpl<WebhookRecord> implements Record11<UUID, String, String, Boolean, LoomEvent, String, JSONB, LocalDateTime, UUID, LocalDateTime, UUID> {
     ...
     */
    public void setTrigger(LoomEvent value) {
        set(4, value);
    }
    ...
    @Override
    public Row11<UUID, String, String, Boolean, LoomEvent, String, JSONB, LocalDateTime, UUID, LocalDateTime, UUID> fieldsRow() {
        return (Row11) super.fieldsRow();
    }

    @Override
    public Row11<UUID, String, String, Boolean, LoomEvent, String, JSONB, LocalDateTime, UUID, LocalDateTime, UUID> valuesRow() {
    ...
    @Override
    public WebhookRecord value5(LoomEvent value) {
        setTrigger(value);
        return this;
    }
    ...
    @Override
    public WebhookRecord value7(JSONB value) {
        setMeta(value);
        return this;
    }
    ...
    @Override
    public WebhookRecord values(UUID value1, String value2, String value3, Boolean value4, LoomEvent value5, String value6, JSONB value7, LocalDateTime value8, UUID value9, LocalDateTime value10, UUID value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public WebhookRecord(UUID uuid, String url, String status, Boolean active, LoomEvent trigger, String secrettoken, JSONB meta, LocalDateTime created, UUID creatorUuid, LocalDateTime edited, UUID editorUuid) {
        super(Webhook.WEBHOOK);
