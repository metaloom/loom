...
public class LoomNamespaceImpl extends AbstractJooqCUDElement implements LoomNamespace, JooqWrapper<Namespace> {

	private final Namespace delegate;

	public LoomNamespaceImpl(Namespace delegate) {
