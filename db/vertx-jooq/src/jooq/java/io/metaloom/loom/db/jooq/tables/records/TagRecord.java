...
public class TagRecord extends UpdatableRecordImpl<TagRecord> implements VertxPojo, Record10<UUID, String, String, UUID, String, Integer, LocalDateTime, UUID, LocalDateTime, UUID>, ITag {
     ...
     */
    @Override
    public TagRecord setUuid(UUID value) {
        set(0, value);
        return this;
    }
     ...
     */
    @Override
    public TagRecord setCollection(String value) {
        set(2, value);
        return this;
    }
     ...
     */
    @Override
    public TagRecord setNamespaceUuid(UUID value) {
        set(3, value);
        return this;
    }
     ...
     */
    @Override
    public TagRecord setMeta(String value) {
        set(4, value);
        return this;
    }
     ...
     */
    @Override
    public TagRecord setRating(Integer value) {
        set(5, value);
        return this;
    }
     ...
     */
    @Override
    public TagRecord setCreated(LocalDateTime value) {
        set(6, value);
        return this;
    }
     ...
     */
    @Override
    public TagRecord setCreatorUuid(UUID value) {
        set(7, value);
        return this;
    }
     ...
     */
    @Override
    public TagRecord setEdited(LocalDateTime value) {
        set(8, value);
        return this;
    }
     ...
     */
    @Override
    public TagRecord setEditorUuid(UUID value) {
        set(9, value);
        return this;
    }
    ...
    @Override
    public Row10<UUID, String, String, UUID, String, Integer, LocalDateTime, UUID, LocalDateTime, UUID> fieldsRow() {
        return (Row10) super.fieldsRow();
    }

    @Override
    public Row10<UUID, String, String, UUID, String, Integer, LocalDateTime, UUID, LocalDateTime, UUID> valuesRow() {
    ...
    @Override
    public TagRecord values(UUID value1, String value2, String value3, UUID value4, String value5, Integer value6, LocalDateTime value7, UUID value8, LocalDateTime value9, UUID value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TagRecord(UUID uuid, String name, String collection, UUID namespaceUuid, String meta, Integer rating, LocalDateTime created, UUID creatorUuid, LocalDateTime edited, UUID editorUuid) {
        super(Tag.TAG);
