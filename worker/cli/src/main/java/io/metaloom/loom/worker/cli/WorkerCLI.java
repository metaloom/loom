...
public class WorkerCLI implements Runnable {

	private static WorkerCLI instance = new WorkerCLI();
	...
	public static int execute(String[] args) {
		CommandLine cmd = new CommandLine(WorkerCLI.instance());
	...
	public static WorkerCLI instance() {
		return instance;
	}
}
